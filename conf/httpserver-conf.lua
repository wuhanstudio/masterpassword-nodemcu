...
if (conf.wifi.mode == wifi.SOFTAP) or (conf.wifi.mode == wifi.STATIONAP) then
   ...
   conf.wifi.accessPoint.config.ssid = "masterpassword" -- Name of the WiFi network to create.
   conf.wifi.accessPoint.config.pwd = "masterpassword"  -- WiFi password for joining - at least 8 characters
